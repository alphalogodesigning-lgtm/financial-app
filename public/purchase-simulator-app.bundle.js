    ...
    return (React.createElement("div", { className: "container" },
        ...
        React.createElement("div", { style: { position: 'relative' } },
            ...
            React.createElement("div", { style: { position: 'fixed', left: '-99999px', top: 0, pointerEvents: 'none' } },
                React.createElement("div", { id: "purchase-share-card-capture", style: {
                        width: '1080px',
                        height: '1080px',
                        background: '#0A0A0A',
                        color: '#F2F2F2',
                    ...
                    React.createElement("div", null,
                        React.createElement("p", { style: { color: '#D4AF37', fontSize: '32px', letterSpacing: '0.16em', textTransform: 'uppercase', marginBottom: '38px' } }, "Reality Check"),
                        React.createElement("h2", { style: { fontSize: '128px', lineHeight: 0.98, letterSpacing: '-0.05em', marginBottom: '56px' } }, simulation?.status || 'ROAST READY'),
                        React.createElement("p", { style: { fontSize: '54px', lineHeight: 1.22, fontWeight: 600, color: '#FFFFFF', maxWidth: '840px' } }, simulation?.roastText || 'Roastly called out this purchase before I made the mistake.')),
                    React.createElement("div", null,
                        React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '26px', marginBottom: '56px' } },
                            React.createElement("div", null,
                                React.createElement("p", { style: { color: '#8A8A8A', fontSize: '24px', marginBottom: '8px' } }, "Purchase"),
                                React.createElement("p", { style: { fontSize: '72px', lineHeight: 1, fontWeight: 800 } },
                                    "RM",
                                    (parseFloat(purchaseAmount || '0') || 0).toFixed(0))),
                            React.createElement("div", null,
                                React.createElement("p", { style: { color: '#8A8A8A', fontSize: '24px', marginBottom: '8px' } }, "Runway Left"),
                                React.createElement("p", { style: { fontSize: '52px', lineHeight: 1, fontWeight: 760 } },
                                    simulation ? (simulation.newRunway < 0 ? 0 : simulation.newRunway) : 0,
                                    " days"))),
